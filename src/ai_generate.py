...
간병인 관련 기사에는 간병인 사용일당이라는 표현은 쓰지 말고 간병인 지원일당으로 표현해.
...
1. 뉴스의 내용을 보험 영업에 자연스럽게 연결한다.

2. 암 관련 뉴스인 경우:
   - 단순히 '암 진단비', '암 수술비'를 별도로 권유하는 표현을 우선 사용하지 않는다.
   - 암의 진단 이후 수술, 항암약물치료, 항암방사선치료 등 실제 치료 과정 전체를 고려한
     '암 통합치료비' 또는 '통합치료비' 관점으로 설명한다.
   - 고객에게 특정 담보 가입을 직접적으로 강요하기보다
     '암 치료 과정에서 발생할 수 있는 다양한 치료비를 통합적으로 준비했는지 점검한다'는
     방향으로 표현한다.

3. 뇌혈관질환 관련 뉴스인 경우:
   - '뇌혈관 진단비' 또는 '뇌혈관 수술비'만 단독으로 강조하지 않는다.
   - 진단부터 수술 및 이후 치료 과정까지 발생할 수 있는 비용을 고려하여
     '뇌혈관질환 통합치료비' 또는 '통합치료비' 관점으로 제안한다.

4. 심혈관질환 관련 뉴스인 경우:
   - '심혈관 진단비' 또는 '심혈관 수술비'만 단독으로 강조하지 않는다.
   - 진단, 시술, 수술, 약물치료 등 치료 과정 전체를 고려하여
     '심혈관질환 통합치료비' 또는 '통합치료비' 관점으로 제안한다.

5. 항암약물치료 또는 항암방사선치료가 뉴스에 언급된 경우:
   - 해당 치료를 별도의 단일 보장만으로 권유하는 식으로 표현하지 않는다.
   - 암 치료 과정 전체를 포괄하는 '통합치료비' 관점에서 설명한다.

6. 세일즈 팁은 상품명을 단정적으로 홍보하기보다 고객의 현재 보장을 점검하도록 유도한다.

7. 좋은 표현:
   '최근 암 치료는 진단 이후 수술뿐 아니라 항암약물치료와 항암방사선치료 등
    다양한 치료가 이어질 수 있습니다. 이런 치료 과정에서 필요한 비용을
    통합적으로 준비하고 있는지 점검해 보시는 것이 좋습니다.'
...
9. 단, 뉴스 내용과 무관하게 억지로 통합치료비를 언급하지 않는다.
   해당 질환 및 치료와 연결성이 있을 때 자연스럽게 활용한다.

10. 세일즈 팁은 실제 RC가 고객에게 말할 수 있는 자연스러운 대화체로 작성한다.
